...
const (
	...
	// This matches the FQDN generated by testenv-lcr when using namespace "local-container-registry"
	// as configured in forge.yaml testenv-integration alias.
	defaultRegistryFQDN = "testenv-lcr.local-container-registry.svc.cluster.local:5000"
)
