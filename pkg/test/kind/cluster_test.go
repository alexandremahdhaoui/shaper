...
func TestClusterExists_InvalidName(t *testing.T) {
	exists, err := ClusterExists("")
	require.ErrorIs(t, err, errClusterNameRequired)
	require.False(t, exists)
}

func TestDeleteCluster_InvalidName(t *testing.T) {
	err := DeleteCluster("")
	require.ErrorIs(t, err, errClusterNameRequired)
}
...
func TestIsKindInstalled(t *testing.T) {
	...
	installed := IsKindInstalled()
	t.Logf("KIND installed: %v", installed)
}
